...
export const mockMedicines: Medicine[] = [
  { id: 'm1',  name: 'Вольтарен Эмульгель гель 1% туба 100 г №1',        mnn: 'Диклофенак',                   manufacturer: 'Novartis',        country: 'Швейцария',    isFavorite: true  },
  { id: 'm2',  name: 'Отривин кап. назал. 0,05% фл.-капельн. 10 мл №1',  mnn: 'Ксилометазолин',               manufacturer: 'Novartis',        country: 'Швейцария',    isFavorite: false },
  { id: 'm3',  name: 'Синекод сироп фл. 200 мл №1',                       mnn: 'Бутамират',                    manufacturer: 'Novartis',        country: 'Швейцария',    isFavorite: false },
  { id: 'm4',  name: 'Нурофен для детей сусп. апельсин 200 мл №1',        mnn: 'Ибупрофен',                    manufacturer: 'Reckitt Benckiser', country: 'Великобритания', isFavorite: true },
  { id: 'm5',  name: 'Парацетамол табл. 500 мг №20',                      mnn: 'Парацетамол',                  manufacturer: 'Биосинтез',       country: 'Россия',       isFavorite: false },
  { id: 'm6',  name: 'Амоксициллин капс. 500 мг №16',                     mnn: 'Амоксициллин',                 manufacturer: 'KRKA',            country: 'Словения',     isFavorite: false },
  { id: 'm7',  name: 'Аугментин табл. п/о 875 мг+125 мг №14',             mnn: 'Амоксициллин+Клавулановая к-та', manufacturer: 'GlaxoSmithKline', country: 'Великобритания', isFavorite: true },
  { id: 'm8',  name: 'Пантопразол табл. 40 мг №28',                       mnn: 'Пантопразол',                  manufacturer: 'Teva',            country: 'Израиль',      isFavorite: false },
  { id: 'm9',  name: 'Лоратадин табл. 10 мг №10',                         mnn: 'Лоратадин',                    manufacturer: 'Акрихин',         country: 'Россия',       isFavorite: false },
  { id: 'm10', name: 'Цетиризин табл. п/о блистер №30',                   mnn: 'Цетиризин',                    manufacturer: 'KRKA',            country: 'Словения',     isFavorite: false },
  { id: 'm11', name: 'Бисопролол табл. 5 мг №30',                         mnn: 'Бисопролол',                   manufacturer: 'Berlin-Chemie',   country: 'Германия',     isFavorite: false },
  { id: 'm12', name: 'Метформин табл. п/п/о 500 мг №60',                  mnn: 'Метформин',                    manufacturer: 'Teva',            country: 'Израиль',      isFavorite: false },
  { id: 'm13', name: 'Омез капс. кишечнораств. 20 мг №30',                mnn: 'Омепразол',                    manufacturer: "Dr. Reddy's",     country: 'Индия',        isFavorite: true  },
  { id: 'm14', name: 'Но-шпа табл. 40 мг №100',                           mnn: 'Дротаверин',                   manufacturer: 'Sanofi',          country: 'Франция',      isFavorite: false },
  { id: 'm15', name: 'Актовегин р-р д/ин. 40 мг/мл амп. 5 мл №5',        mnn: 'Депротеинизированный гемодериват', manufacturer: 'Takeda',       country: 'Австрия',      isFavorite: false },
  { id: 'm16', name: 'Мексидол р-р д/ин. 50 мг/мл амп. 2 мл №10',        mnn: 'Этилметилгидроксипиридина сукцинат', manufacturer: 'Фармасофт', country: 'Россия',       isFavorite: false },
  { id: 'm17', name: 'Эналаприл табл. 10 мг №20',                         mnn: 'Эналаприл',                    manufacturer: 'KRKA',            country: 'Словения',     isFavorite: false },
  { id: 'm18', name: 'Ибупрофен табл. п/о 400 мг №50',                    mnn: 'Ибупрофен',                    manufacturer: 'Биосинтез',       country: 'Россия',       isFavorite: false },
]

const distributors = [
  { id: 'd1',  name: 'MEDSERVICE',      city: 'Алматы'     },
  { id: 'd2',  name: 'PHARMEX',         city: 'Астана'     },
  { id: 'd3',  name: 'TURON PHARM',     city: 'Ташкент'    },
  { id: 'd4',  name: 'MEGA PHARM',      city: 'Ташкент'    },
  { id: 'd5',  name: 'DOSTLIK FARM',    city: 'Бухара'     },
  { id: 'd6',  name: 'BIOMED',          city: 'Алматы'     },
  { id: 'd7',  name: 'ALFA PHARMA',     city: 'Самарканд'  },
  { id: 'd8',  name: 'CENTRAL PHARM',   city: 'Астана'     },
  { id: 'd9',  name: 'ORIENT MED',      city: 'Наманган'   },
  { id: 'd10', name: 'VITA PLUS',       city: 'Ташкент'    },
  { id: 'd11', name: 'FARMAKON',        city: 'Алматы'     },
  { id: 'd12', name: 'PROMEDICA',       city: 'Фергана'    },
  { id: 'd13', name: 'SILK ROAD PHARM', city: 'Самарканд'  },
  { id: 'd14', name: 'HEALTH LINE',     city: 'Астана'     },
  { id: 'd15', name: 'UZPHARM',         city: 'Ташкент'    },
]
